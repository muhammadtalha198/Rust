...
fn main () {
    ...
    println!("first element of tuple is {}",tuple.0);
    println!("second element of tuple is {}",tuple.1);
    println!("third element of tuple is {}",tuple.2);

    //Tuple can be tuple members
    let tuple_of_tuples = ((1u8,2u16,3u32),(4u64,-1i8,-2i16), -2i16);
    // println!("tuple_of_tuples is {}",tuple_of_tuples); //error because {} cannot print tuple directly
